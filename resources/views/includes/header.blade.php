...
<head>
    ...
    <!-- Fonts CSS-->
    <link href="{{URL::asset('css/heading.css')}}" rel="stylesheet">
    <link href="{{URL::asset('css/body.css')}}" rel="stylesheet">
</head>
<body id="page-top">
<nav class="navbar navbar-expand-lg bg-secondary fixed-top" id="mainNav">
    <div class="container"><a class="navbar-brand js-scroll-trigger" href="#page-top">@if(1==1) <p>RamdanEwis</p>  @endif</a>
...
<header class="masthead bg-primary text-white text-center">
    <div class="container d-flex align-items-center flex-column">
        ...
        <!-- Masthead Heading-->
        <h1 class="masthead-heading mb-0"> @if(1==1) <p>RamdanEwis</p>  @endif </h1>
        <!-- Icon Divider-->
        ...
        <!-- Masthead Subheading-->
        <p class="pre-wrap masthead-subheading font-weight-light mb-0">Backend Developer - php</p>
    </div>
</header>
